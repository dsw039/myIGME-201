...
namespace MyEditor_1_
{
    public partial class Form1 : Form
    {
        public Form1(MyEditorParent myEditorParent)
        {
            ...
            this.boldToolStripButton.Click += new EventHandler(BoldToolStripMenuItem__Click);
            this.italicsToolStripButton.Click += new EventHandler(ItalicsToolStripMenuItem__Click);
            this.underlineToolStripButton.Click += new EventHandler(UnderlineToolStripMenuItem__Click);
